...
public class LandForecastStrategy implements CodeTypeStrategy {
    ...
    public String getCodeOn(double x, double y) {
        ...
        Map<String, List<Position>> neighbors
                = positionRepo.findCloseLandForecastPositions(x, y, getPageRequest())
                .stream()
                .collect(
    ...
    public CodeType getType() {
        return CodeType.WEATHER_LAND_FORECAST;
    }
}
